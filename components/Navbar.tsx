        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center gap-2">
              <div className="bg-blue-900 text-white p-1 rounded font-bold text-xs">BS2047</div>
              <span className="text-blue-900 font-bold hidden md:block">Bharat Synapse @2047</span>
            </Link>
          </div>
